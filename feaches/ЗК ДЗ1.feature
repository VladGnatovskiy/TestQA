...
Функционал: Создание Закааза Клиента

Как Гнатовский Владислав Григорьевич (МОП) я хочу
создание Заказа Клиента домашнее задание модуль 1 
чтобы сдать ДЗ  

Сценарий: Создание ЗК
Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий
* Создание Заказ Клиента
...
Сценарий: Проверка суммы Заказа Клиента при изменении кол-ва товаров и цены
* Проверка суммы ЗК
	И я перехожу к закладке с именем "ГруппаТовары"
	И в таблице "Товары" я активизирую поле с именем "ТоварыКоличествоУпаковок"
	И в таблице "Товары" я выбираю текущую строку
	И в таблице "Товары" в поле с именем 'ТоварыКоличествоУпаковок' я ввожу текст '0,200'
	И в таблице "Товары" я завершаю редактирование строки
	И в таблице "Товары" я активизирую поле с именем "ТоварыВидЦены"
	И в таблице "Товары" я выбираю текущую строку
	И в таблице "Товары" из выпадающего списка с именем "ТоварыВидЦены" я выбираю точное значение 'Ростов Розница 1'
	И в таблице "Товары" я завершаю редактирование строки
	И я запоминаю значение поля "Сумма" таблицы "Товары" как "$Сумма$"
